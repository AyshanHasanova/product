...
async function getProducts() {
    ...
    try {
        ...
        for (let i = 0; i < mehsullar.length; i++) {
            ...
            mehsullarinGeleceyiDiv.innerHTML += `
       <div class="w-full max-w-sm bg-white border border-gray-200  shadow dark:bg-gray-800 dark:border-gray-700">
    <a href="#">
        <img class="p-8 rounded-t-lg product-image" src="${mehsullar[i].image}" alt="product image" />
    </a>
    <div class="px-5 pb-5">
        <a href="#">
            <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">"${mehsullar[i].title}"</h5>
        </a>
        <div class="flex items-center mt-2.5 mb-5">
            ...
            <span class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3">"${mehsullar[i].rate}"</span>
        </div>
